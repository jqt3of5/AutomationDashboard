...
function Sidebar(){
    return (
        <div class="sidebar">
            ...
            <SidebarItem title={"Test Runs"} selected={"true"}/>
            <SidebarItem title={"Scenarios"}/>
            <SidebarItem title={"Preferences"}/>
        </div>
    )
}
...
function SidebarItem(props){
    return (
        <div class={props.selected ? "sidebar-item sidebar-item-selected" : "sidebar-item"}>
            <div class={"selected-ribbon" + (props.selected ? " visible" : " hidden")}></div>
            <PrefIcon/>
            <p>{props.title}</p>
